...
static const int TOTAL_BITS = 800;
...
#pragma HLS INLINE
 ...
 ap_uint<4> count_ones = 0;
    ...
    VITIS_LOOP_35_1: for (int i = 0; i < NUM_CLASSES; i++) {
#pragma HLS UNROLL
...
#pragma HLS INLINE
 ...
 label_idx_t label_idx = 0;
    ...
    VITIS_LOOP_60_1: for (int i = 0; i < NUM_CLASSES; i++) {
#pragma HLS UNROLL
...
#pragma HLS INLINE
 ...
 raw_sample_t sample = 0;
    ...
    VITIS_LOOP_132_1: for (int w = 0; w < WORDS_PER_SAMPLE; w++) {
#pragma HLS UNROLL
...
#pragma HLS INLINE
 ...
 int base = sample_idx * WORDS_PER_SAMPLE;
    ...
    VITIS_LOOP_159_1: for (int w = 0; w < WORDS_PER_SAMPLE; w++) {
#pragma HLS UNROLL
